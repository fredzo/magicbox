...
#define LED_D3_LAT LATBbits.LATB6
#define LED_D4_LAT LATBbits.LATB7

#define LED_D1_TRIS TRISBbits.TRISB6
#define LED_D2_TRIS TRISBbits.TRISB7
#define LED_D3_TRIS TRISBbits.TRISB6
#define LED_D4_TRIS TRISBbits.TRISB7

#define LED_D1_ANSEL ANSELBbits.ANSB6
#define LED_D2_ANSEL ANSELBbits.ANSB7
#define LED_D3_ANSEL ANSELBbits.ANSB6
#define LED_D4_ANSEL ANSELBbits.ANSB7
